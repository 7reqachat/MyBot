...
class XatPicker {
  ...
  pickIp(user) {
    return new Promise((resolve, reject) => {
      ...
      https.get('https://xat.com/web_gear/chat/ip2.php', (res) => {
        let body = ''
        res.on('data', (data) => {
          body += data
        }).on('end', () => {
  ...
  _pickIp(user) {
    ...
    if ((_local3[0] & 1) == 1) {
      ...
      prevrpool = _local5;
      return {
        ip: arrayToRet(new Array(_local7[0], _local8, _local4)),
        l5: _local5,
      };
    };
    ...
    return {
      ip: arrayToRet(new Array(_local11, _local10, _local4)),
      l5: _local5,
    };
  }
